...
{}
  ...
  :files $ {}
    'app.comp.candidates $ %{} 'FileEntry
      :defs $ {} $ 'comp-candidates
        %{} 'CodeEntry (:doc |)
          :code $ quote $ defcomp comp-candidates ()
            list->
              {} (:class-name css/row)
                :style $ {} (:height 48)
                  :color $ hsl 230 80 80
          ...
          :code $ quote $ defcomp comp-container (store)
            let
              ...
              div
                ...
                render-banner
                div
                  {} $ :style $ {} (:max-width 1000) (:margin :auto) (:padding "|16px 0")
                  ...
                  div
                    ...
                    button
                      {} (:class-name css/button)
                        :on-click $ fn (e d!)
                          d! :write-code $ js/JSON.stringify (to-js-data tree) nil 2
                      <> |JSON
                    =< 8 nil
                    button
                      {} (:class-name css/button)
                        :on-click $ fn (e d!)
                          d! :write-code $ format-cirru-edn tree
                      <> |EDN
                    =< 8 nil
                    button
                      {} (:class-name css/button)
                        :on-click $ fn (e d!)
                          d! :write-code $ format-cirru tree
                      <> "|Indentation Syntax"
                    =< 8 nil
                    button
                      {} (:class-name css/button)
